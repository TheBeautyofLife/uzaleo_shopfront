<template>
    <v-content>
      ...
      <form enctype="multipart/form-data" novalidate v-if="isInitial || isSaving">
        <p class="headline ma-2 ml-6">Upload images</p>
        <small class="ml-6">Please upload upto two files</small>
        <v-layout class="dropbox" justify-center align-center style="height:46vh!important;">
      ...
      <v-container v-if="isSuccess">
        ...
        <p class="title ma-3">Uploaded file(s) successfully.</p>
        <v-layout pa-3>
        ...
        <v-layout justify-start pa-4>
          <v-btn color="orange" href="javascript:void(0)" @click="reset()">Upload more</v-btn>
        </v-layout>
      </v-container>
      <!--FAILED-->
...
export default {
  ...
  methods: {
    ...
    filesChange (fieldName, fileList) {
      // handle file changes
      const recentlyAddedItem = this.$cookies.get('recently_added_item')
      ...
      formData.append('product_id', recentlyAddedItem._id)
